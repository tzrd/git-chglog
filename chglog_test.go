...
func TestGeneratorNotFoundTags(t *testing.T) {
	...
	gen := NewGenerator(NewLogger(os.Stdout, os.Stderr, false, true),
		&Config{
			...
			Info: &Info{
				RepositoryURL: "https://github.com/tzrd/git-chglog",
			},
			Options: &Options{},
		})
...
[Unreleased]: https://github.com/tzrd/git-chglog/compare/2.0.0-beta.0...HEAD
[2.0.0-beta.0]: https://github.com/tzrd/git-chglog/compare/1.1.0...2.0.0-beta.0
[1.1.0]: https://github.com/tzrd/git-chglog/compare/1.0.0...1.1.0`, expected)
}
...
[Unreleased]: https://github.com/tzrd/git-chglog/compare/3.0.0...HEAD
[3.0.0]: https://github.com/tzrd/git-chglog/compare/2.0.0...3.0.0
[2.0.0]: https://github.com/tzrd/git-chglog/compare/1.0.0...2.0.0`, expected)
...
[Unreleased]: https://github.com/tzrd/git-chglog/compare/3.0.0...HEAD
[3.0.0]: https://github.com/tzrd/git-chglog/compare/2.0.0...3.0.0`, expected)
}
...
[Unreleased]: https://github.com/tzrd/git-chglog/compare/v1.0.0...HEAD`, expected)
...
[Unreleased]: https://github.com/tzrd/git-chglog/compare/1.0.0...HEAD`, expected)
}
